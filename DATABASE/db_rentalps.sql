...
(667, 'cahyaekapermana@gmail.com', 'cahya', 'cahya', '', '', 0);
...
--
-- Table structure for table `packages_rental`
--

CREATE TABLE `packages_rental` (
  `id_package` int(11) NOT NULL,
...
--
-- Dumping data for table `packages_rental`
--

INSERT INTO `packages_rental` (`id_package`, `name`, `price`, `days`, `decs`) VALUES
...
(5, 'salman', 'salman', 'abdullas@gmail.com', 'Abdullas Bin Rizieq', 'Mekkah 666', '12312132312', 'User', '2020-11-16 04:58:59');
...
--
-- Indexes for table `packages_rental`
--
ALTER TABLE `packages_rental`
...
--
ALTER TABLE `auth`
  MODIFY `id_auth` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=668;
...
--
-- AUTO_INCREMENT for table `packages_rental`
--
ALTER TABLE `packages_rental`
...
ALTER TABLE `booking`
  ...
  ADD CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`id_package`) REFERENCES `packages_rental` (`id_package`);
COMMIT;
